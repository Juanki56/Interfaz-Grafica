...
export function ProgrammingManagement({ role, userId, userName }: ProgrammingManagementProps) {
  ...
  return (
    <div className="space-y-6">
      {staffOperativeDetailPage && selectedProgramming ? (
        <div
          className="fixed inset-x-0 bottom-0 top-16 z-[55] overflow-y-auto bg-white lg:left-64 shadow-[0_-4px_24px_rgba(0,0,0,0.06)]"
          role="dialog"
          aria-label="Detalle operativo de programación"
        >
          <div className="mx-auto max-w-6xl px-4 py-4 pb-16 min-w-0">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between min-w-0 mb-6">
              <div className="flex flex-wrap items-center gap-3 min-w-0">
                <Button type="button" variant="outline" size="sm" onClick={closeStaffOperativeDetailPage}>
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-sm text-gray-600">Información operativa, guía, capacidad y reservas de la salida.</p>
                </div>
              </div>
            </div>
                          ...
                          <div className="grid grid-cols-2 gap-3 text-sm">
                            ...
                            <div>
                              ...
                              <p className="font-medium text-green-900">
                                {formatDateTimeDisplay(
                                  selectedProgramming.routes[0].date,
                        ...
                        <div key={idx} className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                          ...
                          <div className="grid grid-cols-3 gap-4 text-sm">
                            ...
                            <div>
                              ...
                              <p className="font-medium text-green-700">{formatTimeDisplay(route.startTime)}</p>
                            </div>
                            <div>
                              <Label className="text-gray-500">Hora de Finalización</Label>
                              <p className="font-medium">{formatTimeDisplay(route.endTime)}</p>
                            </div>
                          </div>
                        </div>
                      ))}
