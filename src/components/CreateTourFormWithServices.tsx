...
export function CreateTourFormWithServices({ isOpen, onClose, onTourCreated, editingTour, onTourUpdated }: CreateTourFormProps) {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[95vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Details */}
          <div className="space-y-4">
            <h3 className="text-lg font-medium text-gray-900">Detalles del Tour</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="includes">Qué Incluye (Adicional a los servicios)</Label>
              <Textarea
                id="includes"
                placeholder="Elementos básicos separados por comas: Guía básico, Seguro, Material informativo..."
