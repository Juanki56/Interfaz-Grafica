...
interface CreateRouteFormWithServicesProps {
  isOpen: boolean;
  onClose: () => void;
...
export function CreateRouteFormWithServices({ 
  isOpen, 
  onClose, 
  onRouteCreated,
  editingRoute,
  onRouteUpdated
}: CreateRouteFormWithServicesProps) {
  ...
  useEffect(() => {
    if (editingRoute) {
      setFormData({
        ...
        coordinator: editingRoute.coordinator || '',
        coordinatorPhone: editingRoute.coordinatorPhone || '',
      ...
      setSelectedServices(editingRoute.services || []);
    } else {
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  id="coordinator"
                  placeholder="Nombre del guía o coordinador"
              ...
              <div className="space-y-2">
                <Label htmlFor="coordinatorPhone">Teléfono del Coordinador</Label>
                <Input
                  id="coordinatorPhone"
